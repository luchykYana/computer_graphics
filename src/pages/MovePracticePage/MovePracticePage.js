...
const MovePracticePage = () => {
    ...
    useEffect(() => {
        ...
        // if( ((Math.abs(point1.x) >= range || Math.abs(point2.x) >= range || Math.abs(point3.x) >= range || Math.abs(point4.x) >= range))
        // || (Math.abs(point1.y) >= range || Math.abs(point2.y) >= range || Math.abs(point3.y) >= range || Math.abs(point4.y) >= range) ) {
        //     dx = 0;
        //     dy = 0;
        // }
